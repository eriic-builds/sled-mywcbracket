...
export function renderDashboard(picks, live, topology) {
  ...
  return '<div class="topbar"><div class="brand"><span class="orb"></span><div>2026 FIFA World Cup - Bracket Dashboard - MSFT SLED<small>Live results vs your picks</small></div></div>' +
    '<div class="upd-group">' +
    `<div class="refreshed glass" id="topRefreshed" title="Results sync from external sources a few times a day, no manual refresh needed"><span class="rf-dot"></span>Last Synced ${localRefreshed(D.REFRESHED)}</div>` +
    syncBtn + '</div>' +
